...
public abstract class PaymentApiService {
  
      public abstract Response paymentPost(String secret,String token,PaymentRequest paymentRequest,SecurityContext securityContext)
