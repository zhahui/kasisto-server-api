...
public abstract class MerchantsApiService {
  
      public abstract Response merchantsPost(String secret,String token,MerchantsRequest merchantsRequest,SecurityContext securityContext)
